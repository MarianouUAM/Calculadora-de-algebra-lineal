...
# ============================================================================
#  SECCIÓN 6: CALCULAR INVERSA DE UNA MATRIZ CUADRADA
#
...
#  Siempre devolvemos:
#     {
#        "es_invertible": True/False,
#        "inversa": matriz o None,
#        "motivo": explicación si no es invertible,
#        "pasos": lista detallada del proceso
#     }
# ============================================================================
...
def calcular_inversa(matriz_original):
    ...
    {
        "es_invertible": True/False,
        "inversa": matriz inversa (si existe),
        "motivo": explicación si no es invertible,
        "pasos": lista de strings con pasos detallados
    }
    """
    pasos = []
